 ...
 *
 * <p>As the outermost interceptor ({@link com.paganbit.telaio.core.adapter.DalAdapterInterceptorProvider#EXPOSURE_PRECEDENCE}),
 * it short-circuits before audit, security, RBAC or the {@link com.paganbit.telaio.core.Dal} itself.</p>
 *
 * @author Marco Pagan
 * @since 1.0.0
 */
