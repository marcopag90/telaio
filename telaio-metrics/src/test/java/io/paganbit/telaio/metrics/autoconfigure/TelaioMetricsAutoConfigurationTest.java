...
import io.paganbit.telaio.metrics.collector.*;
import io.paganbit.telaio.metrics.endpoint.TelaioMetricsEndpoint;
...
import io.paganbit.telaio.metrics.store.InMemoryDalMetricsStore;
import io.paganbit.telaio.metrics.store.jdbc.JdbcDalMetricsStore;
...
class TelaioMetricsAutoConfigurationTest {
    ...
    @io.paganbit.telaio.metrics.annotation.DalMetrics(enabled = false)
