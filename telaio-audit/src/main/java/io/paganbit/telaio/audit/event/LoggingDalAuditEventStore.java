 ...
 * {@code io.paganbit.telaio.audit.AUDIT}) so the host application can route auditing to its own
...
public class LoggingDalAuditEventStore implements DalAuditEventStore {
     ...
     *                  {@code telaio.audit.logging.category} (default {@code io.paganbit.telaio.audit.AUDIT}),
